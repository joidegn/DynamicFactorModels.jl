...
@time results1 = replicate_table(tuples1); gc()
@time results2 = replicate_table(tuples2); gc()
@time results3 = replicate_table(tuples3); gc()
results = vcat(results1, results2, results3)


function replicate_table(sample_tuples, num_reps=10)  # replicate main information criteria of tables 1,2,3
